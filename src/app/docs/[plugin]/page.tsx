      ...
      },
      {
        ...
        blocks: [
          ...
          { kind: "ul", items: [
            ...
            "Cafetera Todo en Uno — muele 3 semillas de café y prepara las dos bebidas. La molienda y el Café Solo llevan minijuego.",
            "Mesa de Ensamblado — monta las dos hamburguesas a partir de sus 4 ingredientes.",
          ]},
          { kind: "h3", id: "def-foods", text: "17 comidas" },
          { kind: "p", text: "Tres crudos, cinco procesados, dos hamburguesas, dos cafés, la esencia de agua y los desechos de fallar los minijuegos. Cada ingrediente tiene una forma de conseguirse y una receta que lo consume: el ciclo cierra sin cabos sueltos." },
          { kind: "h3", id: "def-coffee", text: "Los dos cafés" },
          { kind: "p", text: "Parten del mismo café molido y están pensados como una elección, no como una escalera. Es el ejemplo de referencia de lo que se puede montar con el sistema de efectos en dos fases." },
          { kind: "ul", items: [
            "Café Solo — 1 molido, con minijuego. Un solo trago: Rapidez II y Prisa II durante 45 s, y después un bajón de Lentitud y Fatiga. Fallar el minijuego lo convierte en café quemado.",
            "Café Americano — 1 molido + 1 Esencia de Agua, sin minijuego, y salen 2 tazas. Rapidez I durante 120 s y sin bajón.",
          ]},
          { kind: "p", text: "El Solo pide puntería y puede salir quemado, pero da el efecto fuerte. El Americano gasta una Esencia de Agua de más y a cambio no tiene riesgo y saca el doble de unidades. En el mercado ambas rutas dejan un margen parecido, así que ninguna gana sola." },
          { kind: "callout", callout: { type: "tip", text: "El Café Solo es el único contenido por defecto que usa effects.potion.high-duration y on-crash. Cópialo si quieres una comida con subidón y bajón." } },
      ...
      },
      {
        ...
        blocks: [
          { kind: "ul", items: [
            ...
            "Sistema de plagas: se curan con pesticida a mano o con el Fumigador Automático",
      ...
      },
      {
        ...
        blocks: [
          { kind: "commands", list: [
            ...
            { cmd: "/xfcrops admin giveregadera",      perm: "xfoodscrops.admin", desc: "Entrega la Regadera de Cobre (riego manual)." },
            { cmd: "/xfcrops admin givehoz",           perm: "xfoodscrops.admin", desc: "Entrega la Hoz de Cosecha (40% de semilla extra)." },
            { cmd: "/xfcrops admin givepesticide",     perm: "xfoodscrops.admin", desc: "Entrega pesticida: click derecho sobre una planta con plaga." },
